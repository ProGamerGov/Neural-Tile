...
main(){
	...
	for outfile in `ls $out_dir | grep $clean_name"_"[0-81]".png"`
    do
        convert $out_dir/$outfile -resize "$original_tile_w"x"$original_tile_h"\! $out_dir/$outfile
    done
					#WxH				
	...
	mkdir -p $tiles_dir
	for tile in `ls $out_dir | grep $clean_name"_"[0-81]".png"`
	do
	...
	for tile in `ls $tiles_dir | grep $clean_name"_"[0-81]".png"`
	do
		tile_name="${tile%.*}"
	...
	convert \( $tiles_dir/$clean_name'_0.png' $tiles_dir/$clean_name'_1.png' $tiles_dir/$clean_name'_2.png' $tiles_dir/$clean_name'_3.png' $tiles_dir/$clean_name'_4.png' $tiles_dir/$clean_name'_5.png' $tiles_dir/$clean_name'_6.png' $tiles_dir/$clean_name'_7.png' $tiles_dir/$clean_name'_8.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_9.png' $tiles_dir/$clean_name'_10.png' $tiles_dir/$clean_name'_11.png' $tiles_dir/$clean_name'_12.png' $tiles_dir/$clean_name'_13.png' $tiles_dir/$clean_name'_14.png' $tiles_dir/$clean_name'_15.png' $tiles_dir/$clean_name'_16.png' $tiles_dir/$clean_name'_17.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_18.png' $tiles_dir/$clean_name'_19.png' $tiles_dir/$clean_name'_20.png' $tiles_dir/$clean_name'_21.png' $tiles_dir/$clean_name'_22.png' $tiles_dir/$clean_name'_23.png' $tiles_dir/$clean_name'_24.png' $tiles_dir/$clean_name'_25.png' $tiles_dir/$clean_name'_26.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_27.png' $tiles_dir/$clean_name'_28.png' $tiles_dir/$clean_name'_29.png' $tiles_dir/$clean_name'_30.png' $tiles_dir/$clean_name'_31.png' $tiles_dir/$clean_name'_32.png' $tiles_dir/$clean_name'_33.png' $tiles_dir/$clean_name'_34.png' $tiles_dir/$clean_name'_35.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_36.png' $tiles_dir/$clean_name'_37.png' $tiles_dir/$clean_name'_38.png' $tiles_dir/$clean_name'_39.png' $tiles_dir/$clean_name'_40.png' $tiles_dir/$clean_name'_41.png' $tiles_dir/$clean_name'_42.png' $tiles_dir/$clean_name'_43.png' $tiles_dir/$clean_name'_44.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_45.png' $tiles_dir/$clean_name'_46.png' $tiles_dir/$clean_name'_47.png' $tiles_dir/$clean_name'_48.png' $tiles_dir/$clean_name'_49.png' $tiles_dir/$clean_name'_50.png' $tiles_dir/$clean_name'_51.png' $tiles_dir/$clean_name'_52.png' $tiles_dir/$clean_name'_53.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_54.png' $tiles_dir/$clean_name'_55.png' $tiles_dir/$clean_name'_56.png' $tiles_dir/$clean_name'_57.png' $tiles_dir/$clean_name'_58.png' $tiles_dir/$clean_name'_59.png' $tiles_dir/$clean_name'_60.png' $tiles_dir/$clean_name'_61.png' $tiles_dir/$clean_name'_62.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_63.png' $tiles_dir/$clean_name'_64.png' $tiles_dir/$clean_name'_65.png' $tiles_dir/$clean_name'_66.png' $tiles_dir/$clean_name'_67.png' $tiles_dir/$clean_name'_68.png' $tiles_dir/$clean_name'_69.png' $tiles_dir/$clean_name'_70.png' $tiles_dir/$clean_name'_71.png' +smush -$tiles_dir/$smush_value_w \) \
			\( $tiles_dir/$clean_name'_72.png' $tiles_dir/$clean_name'_73.png' $tiles_dir/$clean_name'_74.png' $tiles_dir/$clean_name'_75.png' $tiles_dir/$clean_name'_76.png' $tiles_dir/$clean_name'_77.png' $tiles_dir/$clean_name'_78.png' $tiles_dir/$clean_name'_79.png' $tiles_dir/$clean_name'_80.png' +smush -$tiles_dir/$smush_value_w \) \
